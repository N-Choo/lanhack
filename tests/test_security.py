...
import lanhack.network as network_mod
from lanhack.network import arp_spoof_loop, arp_scan
...
def test_arp_scan(mock_gethost):
    ...
    with unittest.mock.patch.object(network_mod.scapy, "arping", fake_arping):
